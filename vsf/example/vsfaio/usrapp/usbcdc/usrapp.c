...
{
	.usart_stream.index						= 0,
	.usart_stream.mode						= 1,
	.usart_stream.int_priority				= 0xFF,
	.usart_stream.baudrate					= 115200,
	.usart_stream.stream_tx					= (struct vsf_stream_t *)&usrapp.usbd.cdc.stream_tx,
	.usart_stream.stream_rx					= (struct vsf_stream_t *)&usrapp.usbd.cdc.stream_rx,
