...
#define GD32F1X0_DEF_PWM(index, TIMER, APB, CLKMASK)	\
...
struct gd32f1x0_pwm_t
{
	...
	uint8_t apb;
	uint32_t clkmask;
} static const gd32f1x0_pwm[17] =
{
	GD32F1X0_DEF_PWM(0,		TIMER1,		2,	RCC_APB2CCR_TIMER1EN),
	GD32F1X0_DEF_PWM(1,		TIMER2,		1,	RCC_APB1CCR_TIMER2EN),
	GD32F1X0_DEF_PWM(2,		TIMER3,		1,	RCC_APB1CCR_TIMER3EN),
	GD32F1X0_DEF_PWM(5,		TIMER6,		1,	RCC_APB1CCR_TIMER6EN),
	GD32F1X0_DEF_PWM(13,	TIMER14,	1,	RCC_APB1CCR_TIMER14EN),
	GD32F1X0_DEF_PWM(14,	TIMER15,	2,	RCC_APB2CCR_TIMER15EN),
	GD32F1X0_DEF_PWM(15,	TIMER16,	2,	RCC_APB2CCR_TIMER16EN),
	GD32F1X0_DEF_PWM(16,	TIMER17,	2,	RCC_APB2CCR_TIMER17EN),
};
