#ifndef __VSFVM_CODE_H_INCLUDED__
#define __VSFVM_CODE_H_INCLUDED__
...
#define VSFVM_CODE(type, num)				(((uint32_t)(type) << VSFVM_CODE_LENGTH) + ((num) & ~(0xFFFFFFFF << VSFVM_CODE_LENGTH)))
...
#	define VSFVM_INCLUDE(index)				VSFVM_KEYWORD(VSFVM_CODE_KEYWORD_include, 0, (offset))
...
#define VSFVM_CODE_SYMBOL(code)				((uint32_t)(code) & 0xFF000000)
#define VSFVM_CODE_KEYWORD(code)			((uint32_t)(code) & 0xFF000000)
...
{
	VSFVM_CODE_VARIABLE_NORMAL = 0,
	VSFVM_CODE_VARIABLE_REFERENCE,
	VSFVM_CODE_VARIABLE_REFERENCE_NOTRACE,
	VSFVM_CODE_VARIABLE_RESOURCES,
	VSFVM_CODE_VARIABLE_FUNCTION,
};
...
#endif //__VSFVM_CODE_H_INCLUDED__
